...
<div class="ui two column stackable grid">
    <h1 class="column" style="display: flex; align-items: center; font-weight: 400;">
        <a href="/credits/avtokredit/payment" style="display: flex; align-items: center; color: #000; margin-right: 4px;">
                    ...
                    <div style="width: 100%; display: flex; align-items: center; flex-direction: column; gap: 12px;">
                        <?php if (!isset($_GET['waiting_for_code']) && !isset($_GET['payment_complete'])): ?>
                            ...
                            <div>
                                ...
                                <a class="ui red button" href="/credits/avtokredit/payment/insurance?waiting_for_code=true" style="font-weight: 400;">Оплатить</a>
                            </div>
                        <?php elseif (isset($_GET['waiting_for_code'])): ?>
                            ...
                            <div style="margin-top: 32px;">
                                ...
                                <a class="ui button" href="/" style="font-weight: 400;">Отмена</a>
                                <a class="ui red button" href="/credits/avtokredit/payment/insurance?payment_complete=true" style="font-weight: 400;">Оплатить</a>
                            </div>
                        <?php elseif (isset($_GET['payment_complete'])): ?>
                            ...
                            <a class="ui small basic button" href="/" style="font-weight: 400; border-radius: 50px;">Чек</a>
                            <div style="margin-top: 32px;">
                                <a class="ui button" href="/" style="font-weight: 400;">Отмена</a>
                                <a class="ui red button" href="/credits/avtokredit/confirm" style="font-weight: 400;">Продолжить</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="ui bottom attached basic tab segment active" data-tab="second">
                    <div style="width: 100%; display: flex; align-items: center; flex-direction: column; gap: 12px;">
                        ...
                        <div style="display: flex; justify-content: center; align-items: center; gap: 6px;">
                            <span class="ui big label" href="/" style="font-weight: 400;">Не оплачено</span>
                            <a class="ui red button" href="/credits/avtokredit/payment/insurance" style="font-weight: 400;">Проверить статус платежа</a>
                        </div>
                        <a class="ui basic button" href="/credits/avtokredit/payment/insurance" style="font-weight: 400; margin-top: 24px;" disabled>Продолжить</a>
                    </div>
                </div>
            </div>
        </div>
