<div class="ui two column stackable grid">
    <h1 class="column" style="display: flex; align-items: center; font-weight: 400;"><a href="/credits/avtokredit/oformleniye" style="display: flex; align-items: center; color: #000; margin-right: 4px;"><i class="bx bx-left-arrow-alt"></i> Назад</a></h1>
</div>
    ...
    <form class="ui form" action="/credits/avtokredit/prescoring/result">
        <div class="ui two column stackable internally celled grid">
            <div class="column" style="display: flex; flex-direction: column; gap: 16px;">
                <h1 style="font-weight: 400; margin-bottom: 24px; font-size: 20px; text-align: center;">Пожалуйста оплатите первоначальный взнос</h1>
                <div class="field">
                    ...
                    <div style="width: 100%; display: flex; align-items: center; flex-direction: column; gap: 12px;">
                        <?php if (!isset($_GET['waiting_for_code']) && !isset($_GET['payment_complete'])): ?>
                            ...
                            <div>
                                ...
                                <a class="ui red button" href="/credits/avtokredit/payment?waiting_for_code=true" style="font-weight: 400;" href="">Оплатить</a>
                            </div>
                        <?php elseif (isset($_GET['waiting_for_code'])): ?>
                            ...
                            <div style="margin-top: 32px;">
                                ...
                                <a class="ui button" href="/" style="font-weight: 400;" href="">Отмена</a>
                                <a class="ui red button" href="/credits/avtokredit/payment?payment_complete=true" style="font-weight: 400;" href="">Оплатить</a>
                            </div>
                        <?php elseif (isset($_GET['payment_complete'])): ?>
                            ...
                            <a class="ui basic button" href="/" style="font-weight: 400; border-radius: 50px;" href="">Чек</a>
                            <div style="margin-top: 32px;">
                                <a class="ui button" href="/" style="font-weight: 400;" href="">Отмена</a>
                                <a class="ui red button" href="/credits/avtokredit/payment/insurance" style="font-weight: 400;" href="">Продолжить</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="ui bottom attached basic tab segment active" data-tab="second">
                    <div style="width: 100%; display: flex; align-items: center; flex-direction: column; gap: 12px;">
                        ...
                        <div style="display: flex; justify-content: center; align-items: center; gap: 6px;">
                            ...
                            <a class="ui red button" href="/credits/avtokredit/payment" style="font-weight: 400;" href="">Проверить статус платежа</a>
                        </div>
                        <a class="ui basic button" href="/credits/avtokredit/payment" style="font-weight: 400; margin-top: 24px;" href="" disabled>Продолжить</a>
                    </div>
                </div>
            </div>
        </div>
